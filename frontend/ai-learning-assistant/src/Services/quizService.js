...
const getQuizzesForDocument = async (documentId) => {
    try {
        const response = await axioInstance.get(API_PATHS.QUIZZES.GET_QUIZZES_FOR_DOC(documentId));
...
const getQuizById = async (quizId) => {
    try {
        const response = await axioInstance.get(API_PATHS.QUIZZES.GET_QUIZ_BY_ID(quizId));
        return response.data;
    } catch (error) {
...
const submitQuiz = async (quizId, answers) => {
    try {
        const response = await axioInstance.post(API_PATHS.QUIZZES.SUBMIT_QUIZ(quizId), { answers });
        return response.data;
    } catch (error) {
...
const deleteQuiz = async (quizId) => {
    try {
        const response = await axioInstance.delete(API_PATHS.QUIZZES.DELETE_QUIZ(quizId));
        return response.data;
    } catch (error) {
