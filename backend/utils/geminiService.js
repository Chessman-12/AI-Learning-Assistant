...
export const generateSummary = async (text) => {
    const prompt = `Provide a concise summary of the following text, highlighting key concepts, main ideas, and important points.
    Keep the summary clear and structered.
